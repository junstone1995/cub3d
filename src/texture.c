...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/19 15:07:19 by junseole          #+#    #+#             */
/*   Updated: 2021/11/19 15:13:36 by junseole         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_texture(t_game *game)
{
	...
	while (++i < TEXTURES - 3)
	{
		game->config.tex[i].texture = load_image(game,
				game->config.tex[i].tex_path, &img, i);
